...
<html>
    ...
    <div class="d-flex">
        <div class="card col-sm-4">
            <div class="card-body">
                <form action="Controlador?menu=AlumnoSecundario" method="POST">
                            ...
                            <tbody> 
                                <c:forEach var="alu" items="${alumnos}">
                                    <tr>
                                        ...
                                        <td>${alu.getEstado()}</td>
                                        <td>
                                            <a class="btn btn-warning" href="Controlador?menu=AlumnoSecundario&accion=Editar&id=${alu.getId()}">Editar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
